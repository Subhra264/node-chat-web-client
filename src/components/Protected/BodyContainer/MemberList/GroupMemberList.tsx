...
const GroupMemberList: React.FC = (props): JSX.Element => {
  ...
  const generateInviteLink = () => {
    ...
    const successHandler = (result: any) => {
      ...
      setInviteModalContent(
        window.location.host + '/join-group/' + result.invitationToken,
      );
    };
    ...
    protectedRequest(fetchDetais, successHandler, errorHandler);
  };
  ...
  return (
    ...
    >
      ...
      >
        <div className="invite-modal-content">{inviteModalContent}</div>
      </ModalBox>
    </MemberList>
  );
};
